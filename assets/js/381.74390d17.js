...
var mermaid_59c9be08 = __webpack_require__(2567);
...
var esm = __webpack_require__(3047);
...
/* harmony export */ });
/* harmony import */ var _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2567);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4218);
/* harmony import */ var _createText_31840e8c_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2122);
...
var flowDb_99855667 = __webpack_require__(7688);
...
var dagre = __webpack_require__(2865);
...
var createNodes = function (selection, g, shapes) {
  ...
  svgNodes.each(function (v) {
    ...
    var bbox = (0,pick/* default */.Z)(labelDom.node().getBBox(), 'width', 'height');
...
function preProcessGraph(g) {
  g.nodes().forEach((v) => {
    ...
    (0,defaults/* default */.Z)(node, NODE_DEFAULT_ATTRS);
  ...
  g.edges().forEach(function (e) {
    ...
    (0,defaults/* default */.Z)(edge, EDGE_DEFAULT_ATTRS);
  });
}
...
var styles_38506eb2 = __webpack_require__(9510);
...
const addEdges = async function(edges, g, diagObj) {
  ...
  for (const edge of edges) {
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,mermaid_59c9be08.n)(edge.interpolate, src/* curveLinear */.c_6);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,mermaid_59c9be08.n)(edges.defaultInterpolate, src/* curveLinear */.c_6);
    } else {
      edgeData.curve = (0,mermaid_59c9be08.n)(conf.curve, src/* curveLinear */.c_6);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
...
/* harmony export */ });
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2865);
/* harmony import */ var dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6060);
/* harmony import */ var _edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6057);
/* harmony import */ var _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2567);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5625);
/* harmony import */ var _createText_31840e8c_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2122);
...
const adjustClustersAndEdges = (graph, depth) => {
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Adjusted Graph", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph));
  extractor(graph, 0);
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.trace(clusterDb);
};
const extractor = (graph, depth) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("extractor - ", depth, dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph), graph.children("D"));
  if (depth > 10) {
  ...
  for (const node of nodes) {
    ...
    graph.children(node) && graph.children(node).length > 0) {
      ...
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Old graph before copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph));
      ...
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("New graph after copy node: (", node, ")", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(clusterGraph));
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Old graph after copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph));
    } else {
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.warn(
        "Cluster ** ",
        node,
...
const recursiveRender = async (_elem, graph, diagramType, id, parentCluster, siteConfig) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph in recursive render: XXX", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph), parentCluster);
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph after layout:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph));
  let diff = 0;
...
const render = async (elem, graph, markers, diagramType, id) => {
  ...
  clear();
  clear$1();
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph at first:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph)));
  adjustClustersAndEdges(graph);
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph after:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph)));
  const siteConfig = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)();
...
/* harmony import */ var _index_bf99f535_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6364);
/* harmony import */ var _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2567);
...
const addEdges = async function(edges, g, diagObj) {
  ...
  for (const edge of edges) {
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_2__.n)(edge.interpolate, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .c_6);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_2__.n)(edges.defaultInterpolate, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .c_6);
    } else {
      edgeData.curve = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_2__.n)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .c_6);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
        edgeData.arrowheadStyle = "fill: #333";
...
const draw = async function(text, id, _version, diagObj) {
  ...
  for (i = subGraphs.length - 1; i >= 0; i--) {
    subG = subGraphs[i];
    (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .selectAll */ .td_)("cluster").append("text");
    for (let j = 0; j < subG.nodes.length; j++) {
  ...
  keys.forEach(function(key) {
    const vertex = vert[key];
    if (vertex.link) {
      const node = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ys)("#" + id + ' [id="' + key + '"]');
      if (node) {
        const link = doc.createElementNS("http://www.w3.org/2000/svg", "a");
        link.setAttributeNS("http://www.w3.org/2000/svg", "class", vertex.classes.join(" "));
        link.setAttributeNS("http://www.w3.org/2000/svg", "href", vertex.link);
